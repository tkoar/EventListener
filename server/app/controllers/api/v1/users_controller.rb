    ...
    class UsersController < ApplicationController
      ...
      def create
        if User.find_by(userID: user_params[:userID])
          ...
          @user = User.create(name: user_params[:name], email: user_params[:email], userID: user_params[:userID], accessToken: user_params[:accessToken], icon: params[:user][:picture][:data][:url], current_city_lat: params[:location][:lat], current_city_lng: params[:location][:lng], current_city: params[:location][:name])
        end
